...
class InputSalesItemImage(_message.Message):
    __slots__ = ("rank", "url")
    RANK_FIELD_NUMBER: _ClassVar[int]
    URL_FIELD_NUMBER: _ClassVar[int]
    rank: int
    url: str
    def __init__(self, rank: _Optional[int] = ..., url: _Optional[str] = ...) -> None: ...
...
class InputSalesItem(_message.Message):
    ...
    name: str
    priceInCents: int
    images: _containers.RepeatedCompositeFieldContainer[InputSalesItemImage]
    def __init__(self, name: _Optional[str] = ..., priceInCents: _Optional[int] = ..., images: _Optional[_Iterable[_Union[InputSalesItemImage, _Mapping]]] = ...) -> None: ...
...
class SalesItemUpdate(_message.Message):
    ...
    priceInCents: int
    images: _containers.RepeatedCompositeFieldContainer[InputSalesItemImage]
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., priceInCents: _Optional[int] = ..., images: _Optional[_Iterable[_Union[InputSalesItemImage, _Mapping]]] = ...) -> None: ...

class OutputSalesItemImage(_message.Message):
    ...
    rank: int
    url: str
    def __init__(self, id: _Optional[str] = ..., rank: _Optional[int] = ..., url: _Optional[str] = ...) -> None: ...
...
class OutputSalesItem(_message.Message):
    ...
    name: str
    priceInCents: int
    images: _containers.RepeatedCompositeFieldContainer[OutputSalesItemImage]
    def __init__(self, id: _Optional[str] = ..., createdAtTimestampInMs: _Optional[int] = ..., name: _Optional[str] = ..., priceInCents: _Optional[int] = ..., images: _Optional[_Iterable[_Union[OutputSalesItemImage, _Mapping]]] = ...) -> None: ...
